...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    // 1. Si hay caché, la mostramos al instante (Cero latencia para usuarios viejos)
    if (cachedData) {
      try {
    ...
    // 2. Comprobamos preferencias ANTES de pedir datos nuevos
  ...
  const savePreferences = async () => {
    ...
    try {
      ...
      if (allTransactions.length === 0) {
        ...
        await fetchData(undefined, true); // forceSync = true
      } else {
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-stretch">
                <div className="md:col-span-5 flex flex-col gap-5">
                  ...
                  <VelocityAnalysis totalExpenses={totalExpenses} totalIncome={totalIncome} selectedMonth={selectedMonth} selectedYear={selectedYear} prefSavingsGoal={prefSavingsGoal} />
                </div>
