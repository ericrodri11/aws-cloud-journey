...
def lambda_handler(event, context):
    try:
        ...
        # --- DETERMINAR EL TIPO DE INVOCACIÓN Y HORARIO
        ...
        if is_report_time or force_sync or not is_api_request:
            ...
            saved_items = get_transactions_from_dynamo(user_id) # CORREGIDO
            if not saved_items:
        ...
        return {
            ...
            'body': json.dumps({
                ...
                "data": {
                    ...
                    "total_expenses": total_expenses, "projected_spend": projected_spend, "current_streak": current_streak
                }
            }, default=str)
        }
    except Exception as e:
