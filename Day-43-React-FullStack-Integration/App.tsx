...
import { 
  ...
  Cpu, CreditCard, Activity, CheckCircle2, Search, Target, Send, Flame
} from 'lucide-react';
import { 
...
const App: React.FC = () => {
  ...
  const [currentStreak, setCurrentStreak] = useState(0); // NUEVO ESTADO DÍA 43
  ...
  const fetchData = async (query?: string) => {
      try {
        ...
        if (result.data) {
            ...
            setCurrentStreak(result.data.current_streak || 0); // CAPTURAR RACHA
