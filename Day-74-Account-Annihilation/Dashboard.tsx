...
const Dashboard = () => {
  ...
  const savePreferences = async () => {
    ...
    // Si no hay transacciones en memoria, es un usuario nuevo configurando su perfil.
    // Activamos la pantalla inmersiva de carga pesada.
    ...
    try {
      ...
      // Forzamos al sistema a descargar los datos frescos ya con el nombre asignado
    ...
    setIsProvisioning(false); // Apaga la capa inmersiva inmediatamente al terminar
  };
        ...
        {isProvisioning && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-gray-900/30 backdrop-blur-xl transition-all duration-500">
            <div className="bg-white border border-gray-100 shadow-2xl rounded-3xl p-10 w-[360px] flex flex-col items-center relative overflow-hidden">
              ...
              {/* Clean Typography */}
              <h3 className="text-lg font-black text-gray-900 tracking-tight text-center mb-2" style={{ letterSpacing: '-0.02em' }}>
                Provisioning Agent
              </h3>
              <div className="h-6 flex items-center justify-center">
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest text-center animate-pulse">
